  ...
  if (!data || data?.processing) {
    return (
      <div className="flex flex-col items-center justify-center">
        <Typography className="mb-10" variant={'h2'}>
          Analizujemy twoje wideo. Wróc do nas za kilka chwil
        </Typography>
        ...
        <svg
          ...
          width="600"
        >
          <circle cy="110.72662" fill="#e6e6e6" cx="39.53587" r="13.63057" />
          <circle cy="110.72662" fill="#e6e6e6" cx="80.42757" r="13.63057" />
          <circle cx="121.31927" cy="110.72662" fill="#e6e6e6" r="13.63057" />
          <circle cx="162.21097" cy="110.72662" fill="#e6e6e6" r="13.63057" />
          <circle cx="203.10267" cy="110.72662" fill="#e6e6e6" r="13.63057" />
          <circle cx="243.99437" cy="110.72662" fill="#e6e6e6" r="13.63057" />
          <circle cx="284.88607" cy="110.72662" fill="#e6e6e6" r="13.63057" />
          <path
          ...
          <rect
            ...
            y="254.22076"
          />
          <circle cy="533.69821" fill="#3f3d56" cx="506.244" r="11.56459" />
